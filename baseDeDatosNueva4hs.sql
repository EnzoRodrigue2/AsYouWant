...
INSERT INTO `usuarios` VALUES (1,'Adriel','Colombo','adrielcolombo23@gmail.com',4,1,NULL,NULL,NULL,'/api/users/1'),(2,'Arvin','Bizley','abizley1@tamu.edu',2,2,NULL,NULL,NULL,'/api/users/2'),(3,'Riki','Dow','rdow2@deviantart.com',3,3,NULL,NULL,NULL,'/api/users/3'),(4,'Alli','Howey','ahowey3@issuu.com',1,2,NULL,NULL,NULL,'/api/users/4'),(5,'Maribel','Baggally','mbaggally4@nationalgeographic.com',2,1,NULL,NULL,NULL,'/api/users/5'),(6,'Morna','Gumley','mgumley5@feedburner.com',1,2,NULL,NULL,NULL,'/api/users/6'),(7,'Cyndie','Synnott','csynnott6@cafepress.com',1,2,NULL,NULL,NULL,'/api/users/7'),(8,'Eada','Stiegers','estiegers7@cnbc.com',1,2,NULL,NULL,NULL,'/api/users/8'),(9,'Lucais','Wittering','lwittering8@fda.gov',2,3,NULL,NULL,NULL,'/api/users/9'),(10,'Arlette','Cantillon','acantillon9@digg.com',1,2,NULL,NULL,NULL,'/api/users/10'),(11,'Norris','Aldin','naldin0@icio.us',1,1,NULL,NULL,NULL,'/api/users/11'),(12,'Pauli','Monjes','paulimonjes@gmail.com',4,NULL,'Hola1234','user-1655914082764.jpg','Me llamo paulina y me gustan los sanguchitos de miga y la pizza','/api/users/12'),(13,'Ramiro','Monjes','rmonjes@frsn.utn.edu.ar',4,NULL,'123456789','user-1655924239250.jpg','Hola','/api/users/13');
...
-- Dump completed on 2022-06-22 16:38:42
